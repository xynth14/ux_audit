...
<main class="wrap">
  <section>
    ...
    <div class="idx-grid">
      ...
      <a class="idx-row" href="calidad-plataforma.html">
        <span>
          <span class="idx-row__t">Auditoría de calidad de la plataforma</span>
          <span class="idx-row__d">Once dimensiones valoradas con su evidencia, más lo que no se puede afirmar y por qué.</span>
        </span>
        <span class="idx-sev"><span class="pill" style="color:var(--blueprint)">abrir →</span></span>
      </a>
    </div>
